...
PYBIND11_MODULE(linalg_core, m) {
  ...
  py::class_<LinearAlgebra>(m, "LinearAlgebra")
      ...
      .def_static("cosine_similarity", &LinearAlgebra::cosine_similarity, R"doc(
          Returns cosine similarity between matrices using BLAS.
          Dimension along which cosine similarity is computed: dim=1
